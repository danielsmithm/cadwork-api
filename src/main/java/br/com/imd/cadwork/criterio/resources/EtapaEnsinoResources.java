package br.com.imd.cadwork.criterio.resources;
...
import br.com.imd.cadwork.criterio.service.EtapaEnsinoService;
...
public class EtapaEnsinoResources {
	...
	public ResponseEntity<String> salvar(@Valid @RequestBody EtapaEnsino etapaEnsino, BindingResult resultado) throws GenericServiceException {
