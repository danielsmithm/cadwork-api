node {
    stage('Configure') {
        ...
        properties([
                ...
                [$class: 'GithubProjectProperty', displayName: '', projectUrlStr: 'https://github.com/CADEduc/cadeduc-api/'],
                pipelineTriggers([[$class: 'GitHubPushTrigger']])
            ])
    }

    stage('Checkout') {
        git 'https://github.com/CADEduc/cadeduc-api'
        git checkout 09_DocumentarAPI
    }
    ...
    stage('Deploy') {
        ...
        withCredentials([[$class          : 'UsernamePasswordMultiBinding', credentialsId: 'cloudfoundry',
            ...
            sh '''
                ...
                ./cf target -o cadeduc -s development
                ./cf push
               '''
        }
    }
